...
public class StructuredVehicleDetails
{
    ...
    public StructuredVehicleColor? StructuredVehicleColor { get; set; }
    
    [XmlElement("KoeretoejMiljoeOplysningStruktur")]
    public StructuredVehicleEnvironmentDetails? StructuredVehicleEnvironmentDetails { get; set; }
    
    [XmlElement("KarrosseriTypeStruktur")]
    public StructuredVehicleChassis? StructuredVehicleChassis { get; set; }
}